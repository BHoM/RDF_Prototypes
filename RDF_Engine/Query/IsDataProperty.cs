...
namespace BH.Engine.Adapters.RDF
{
    ...
    {
        public static bool IsDataProperty(this PropertyInfo pi, ABoxSettings aBoxSettings)
        {
            ...
            return pi.PropertyType.IsDataType(aBoxSettings) && pi.DeclaringType.IsOntologyClass(aBoxSettings);
        }
    }
}
